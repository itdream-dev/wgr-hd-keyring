...
One of the goals of this class is to allow developers to easily add new signing strategies to Wgr Extension wallet. We call these signing strategies Keyrings, because they can manage multiple keys.
...
You must return a valid signed tx object when complete, it can be the same transaction you received.
